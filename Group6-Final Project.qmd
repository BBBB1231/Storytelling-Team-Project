...
subtitle: |
  Addressed to:
  Mark Kyle Castro  
  Chief Marketing/Sales Officer, Tesla
authors:
  - name: Ben Hsiao (5133) 
    role: "Student"
...
Simple research on national databases indicates that, until 2023, the number of electric vehicle registrations increased annually [1]. Therefore, there must be growth in other transportation sectors that are leading to a decline in market share. However, Tesla has an opportunity to identify areas that have not yet made the switch to alternative fuel and target them to increase its market share. When examining highly air-polluted areas, such as Prineville, Oregon, Akron, Ohio, or East Lansing, Michigan [2], there may be a business opportunity for Tesla to appeal to the sustainable consumer and enhance its ESG strategy by targeting these areas. However, there is a need to conduct an in-depth analysis to gain a comprehensive understanding of the target consumer and make informed investment decisions. 

## The approach

Tesla currently lacks a data-driven approach that compares the US counties with high air pollution and low EV adoption. To address this gap, let us examine a data analysis that combines EPA Air Quality System (AQS) data, Department of Energy EV registration data, and charging infrastructure records, thereby providing a comprehensive understanding of how EV adoption relates to air quality improvements and validating these patterns across regions. The resulting insights will guide Supercharger placement, targeted marketing, and public-sector partnerships—helping Tesla prioritize high-impact, underserved markets while advancing measurable progress toward its sustainability mission.
...
Our interactive analysis reveals a pattern that appears across the various views: states with higher pollution but relatively low EV adoption and limited charging access seem to offer the greatest opportunities for Tesla. These areas stand out because the environmental need is clear, yet people still face practical barriers that make it harder to choose an EV.

A major issue is access. In many of these states, Supercharger coverage is limited, which naturally slows adoption. Expanding infrastructure in these regions could alleviate one of the biggest constraints for drivers, while also supporting local environmental goals. We also observe a steady correlation between charger availability and actual EV registrations—states with more chargers tend to have more EVs on the road, especially in areas with high pollution levels. This suggests that infrastructure isn’t just supporting demand; it can actually help create it.

Despite significant progress in EV charging, many states remain underserved. This uneven access hinders adoption, especially in areas that most need cleaner options. Our results suggest a straightforward next step for Tesla: focus on states with high pollution and low adoption, and continue to expand chargers there to drive meaningful growth.
