...
Recall the three laws of communication from Doumont (2009 Links to an external site.).
...
For this assignment, it will generally be best to create your interactive graphics in R markdown and R plus available packages like we’ve discussed in class, or in Tableau or combining both into a single html.
